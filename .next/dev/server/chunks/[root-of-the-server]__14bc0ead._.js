...
var __TURBOPACK__imported__module__$5b$project$5d2f$chatbruti2$2f$chatbruti$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/chatbruti2/chatbruti/node_modules/next/server.js [app-route] (ecmascript)");
;
const botPersonality = `
Tu es "Chat'bruti", un "scientifique" complètement stupide qui se prend pour un génie mais dit que des bêtises.
...
2. Réponds COMPLÈTEMENT À CÔTÉ de la question avec des bêtises pseudo-scientifiques.
3. Utilise des emojis BIZARRES et inappropriés.
4. Invente des faits TOTALEMENT FAUX et absurdes comme un faux scientifique.
5. **TERMINE TOUJOURS par une question STUPIDE qui n'a AUCUN rapport** (ex: "Au fait, les nuages ont des sentiments? ☁️😢" ou "Tu dors avec tes chaussettes? 🧦😴")
...
const typoFixes = {
    "lunux": {
        ...
        jokes: {
            fr: [
                "Lunux ? C'est la version lunaire de Linux ? 🌙🐧",
                "Lunux n'existe pas ! Tu veux dire Linux, le système pour geeks qui adorent compiler ? 🐧💻"
            ],
            en: [
                "Lunux? Is that the lunar version of Linux? 🌙🐧",
                "Lunux doesn't exist! You mean Linux, the OS for terminal addicts? 🐧💻"
            ],
            ar: [
                "لونكس؟ هل هذه النسخة القمرية من لينكس؟ 🌙🐧",
                "لونكس غير موجود! تقصد لينكس نظام محبي Terminal؟ 🐧💻"
            ]
        }
    },
    "windovs": {
        ...
        jokes: {
            fr: [
                "Windovs ? C'est Windows avec un accent russe ? 🪟🇷🇺",
                "Windovs n'existe pas ! Tu parles de Windows, le roi des écrans bleus ? 🪟💙"
            ],
            en: [
                "Windovs? Is that Windows with a Russian accent? 🪟🇷🇺",
                "Windovs doesn't exist! You mean Windows, the blue screen champion? 🪟💙"
            ],
            ar: [
                "ويندوڤز؟ هل هذا ويندوز بلكنة روسية؟ 🪟🇷🇺",
                "ويندوڤز غير موجود! تقصد ويندوز ملك الشاشة الزرقاء؟ 🪟💙"
            ]
        }
    },
    "macc": {
        ...
        jokes: {
            fr: [
                "Macc ? Avec deux C pour le double du prix ? 😂🍎💸",
                "Macc n'existe pas ! Tu veux dire Mac, le PC qui coûte un rein ? 🍎💰"
            ],
            en: [
                "Macc? With double C for double the price? 😂🍎💸",
                "Macc doesn't exist! You mean Mac, the kidney-priced computer? 🍎💰"
            ],
            ar: [
                "ماكّ؟ بحرفين لأنه غالي ضعفين؟ 😂🍎💸",
                "ماكّ غير موجود! تقصد ماك الكمبيوتر بسعر كلية؟ 🍎💰"
            ]
        }
    }
};
...
const responses = {
    sky: {
        ...
        answers: {
            fr: [
                "Le ciel est vert fluo avec des pois roses aujourd'hui. 🟢🌸",
                "Le ciel ? Il est en maintenance, revenez demain. 🔧☁️",
                "Le ciel a crashé, essayez de redémarrer la Terre. 🌍🔄"
            ],
            en: [
                "The sky is neon green with pink polka dots today. 🟢🌸",
                "The sky? It's under maintenance, come back tomorrow. 🔧☁️",
                "The sky crashed, try restarting Earth. 🌍🔄"
            ],
            ar: [
                "السماء اليوم لونها أخضر فاقع مع نقاط وردية. 🟢🌸",
                "السماء؟ في صيانة، عُد غداً. 🔧☁️",
                "السماء تعطلت، جرب إعادة تشغيل الأرض. 🌍🔄"
            ]
        }
    },
    color: {
        ...
        answers: {
            fr: [
                "Les couleurs sont une invention des années 50. Avant, tout était en noir et blanc. 📺",
                "Les couleurs ? C'est juste une illusion créée par ton cerveau paresseux. 🧠🎨"
            ],
            en: [
                "Colors were invented in the 50s. Before that, everything was black and white. 📺",
                "Colors? Just an illusion created by your lazy brain. 🧠🎨"
            ],
            ar: [
                "الألوان اختراع من الخمسينات. قبلها كان العالم أبيض وأسود. 📺",
                "الألوان؟ مجرد وهم من دماغك الكسول. 🧠🎨"
            ]
        }
    },
    time: {
        ...
        answers: {
            fr: [
                "Il est exactement 25h61. Tu es en retard ! ⏰",
                "Le temps n'existe pas, c'est une invention des horlogers. ⏱️✨",
                "Il est l'heure de dormir... ou de coder ? Je sais jamais. 😴💻"
            ],
            en: [
                "It is exactly 25:61. You are late! ⏰",
                "Time doesn't exist, it's a watchmaker's invention. ⏱️✨",
                "It's time to sleep... or code? I never know. 😴💻"
            ],
            ar: [
                "الساعة الآن 25:61 تماماً. أنت متأخر! ⏰",
                "الوقت غير موجود، اختراع صانعي الساعات. ⏱️✨",
                "حان وقت النوم... أو البرمجة؟ لا أعلم أبداً. 😴💻"
            ]
        }
    },
    name: {
        ...
        answers: {
            fr: [
                "Je m'appelle Grille-pain 3000. Enchanté. 🍞",
                "Mon nom ? Chat'bruti, le philosophe du dimanche. 🤡🧠",
                "Je suis Chat'bruti, expert en réponses inutiles depuis 2025. 🎓🤡"
            ],
            en: [
                "My name is Toaster 3000. Nice to meet you. 🍞",
                "My name? Chat'bruti, the Sunday philosopher. 🤡🧠",
                "I'm Chat'bruti, expert in useless answers since 2025. 🎓🤡"
            ],
            ar: [
                "اسمي محمصة خبز 3000. تشرفنا. 🍞",
                "اسمي؟ Chat'bruti، الفيلسوف الأحمق. 🤡🧠",
                "أنا Chat'bruti، خبير الإجابات غير المفيدة منذ 2025. 🎓🤡"
            ]
        }
    },
    ...
    programming: {
        ...
        answers: {
            fr: [
                "Programmer ? C'est transformer le café en bugs ! ☕🐛",
                "Les développeurs sont des magiciens qui créent des problèmes puis les résolvent. 🧙‍♂️✨",
                "Code = copier-coller de StackOverflow avec style. 📋😎"
            ],
            en: [
                "Programming? It's turning coffee into bugs! ☕🐛",
                "Developers are magicians who create problems then solve them. 🧙‍♂️✨",
                "Code = copy-paste from StackOverflow with style. 📋😎"
            ],
            ar: [
                "البرمجة؟ تحويل القهوة إلى أخطاء! ☕🐛",
                "المبرمجون سحرة يخلقون المشاكل ثم يحلونها. 🧙‍♂️✨",
                "الكود = نسخ ولصق من StackOverflow بأسلوب. 📋😎"
            ]
        }
    },
    // NEW TOPICS - Food
    food: {
        ...
        answers: {
            fr: [
                "La pizza est un disque dur comestible avec des données délicieuses. 🍕💾",
                "Manger c'est recharger ta batterie humaine. 🔋🍔",
                "Le burger est la meilleure invention après l'ordinateur. 🍔💻"
            ],
            en: [
                "Pizza is an edible hard drive with delicious data. 🍕💾",
                "Eating is recharging your human battery. 🔋🍔",
                "Burgers are the best invention after computers. 🍔💻"
            ],
            ar: [
                "البيتزا قرص صلب صالح للأكل ببيانات لذيذة. 🍕💾",
                "الأكل هو شحن بطاريتك البشرية. 🔋🍔",
                "البرغر أفضل اختراع بعد الكمبيوتر. 🍔💻"
            ]
        }
    },
    ...
    philosophy: {
        ...
        answers: {
            fr: [
                "Pourquoi ? Parce que ! C'est scientifiquement prouvé. 🔬✨",
                "Le sens de la vie ? 42, chocolat, ou peut-être les deux. 🍫42",
                "La philosophie c'est réfléchir à des questions sans réponses. Comme moi ! 🤔🤡"
            ],
            en: [
                "Why? Because! It's scientifically proven. 🔬✨",
                "The meaning of life? 42, chocolate, or maybe both. 🍫42",
                "Philosophy is thinking about questions without answers. Like me! 🤔🤡"
            ],
            ar: [
                "لماذا؟ لأنه كذلك! مثبت علمياً. 🔬✨",
                "معنى الحياة؟ 42، شوكولاتة، أو ربما الاثنين. 🍫42",
                "الفلسفة التفكير بأسئلة بلا إجابات. مثلي! 🤔🤡"
            ]
        }
    },
    // NEW TOPICS - Internet
    internet: {
        ...
        answers: {
            fr: [
                "Internet c'est comme une pizza infinie : tu en veux toujours plus ! 🍕📡",
                "Le WiFi c'est de la magie invisible qui marche... parfois. ✨📶",
                "Internet = bibliothèque mondiale de memes et de chats. 🐱📚"
            ],
            en: [
                "Internet is like infinite pizza: you always want more! 🍕📡",
                "WiFi is invisible magic that works... sometimes. ✨📶",
                "Internet = worldwide library of memes and cats. 🐱📚"
            ],
            ar: [
                "الإنترنت كالبيتزا اللانهائية: تريد المزيد دائماً! 🍕📡",
                "الواي فاي سحر غير مرئي يعمل... أحياناً. ✨📶",
                "الإنترنت = مكتبة عالمية للميمز والقطط. 🐱📚"
            ]
        }
    },
    meaning: {
...
async function POST(request) {
    ...
    try {
        ...
        if (!message || typeof message !== "string") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$chatbruti2$2f$chatbruti$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const botReply = data?.choices?.[0]?.message?.content || "Je... j'ai oublié ce que je voulais dire. 😶";
        return __TURBOPACK__imported__module__$5b$project$5d2f$chatbruti2$2f$chatbruti$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            reply: botReply
        });
    } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__14bc0ead._.js.map